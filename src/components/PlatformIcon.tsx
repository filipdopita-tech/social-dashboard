...
export function PlatformIcon({ platform, size = 20 }: PlatformIconProps) {
  ...
  if (p === "tiktok") {
    return (
      <svg width={size} height={size} viewBox="0 0 24 24">
        ...
        <path fill="#010101" d="M16.436 4.19c-.08-1.53-.63-3.09-1.75-4.17h1.75c.12 1.38.52 2.76 1.3 3.89.14-.01.28-.02.42-.02.23.85.57 1.66 1.02 2.39-1.54-.17-3.12-.68-4.24-1.79-.22-.22-.41-.46-.58-.71.08.14.08.28.08.41z" />
      </svg>
    );
  }
  ...
  // Default
  return (
    <div style={{ width: size, height: size, borderRadius: "50%", background: "#1e1e22", display: "flex", alignItems: "center", justifyContent: "center" }}>
